...
public class HoverCarControl : MonoBehaviour
{
  ...
  void Update()
  {
    ...
    // Main Thrust
    m_currThrust = 0.0f;
		float aclAxis = getLoudness * powerup; // To switch blowing control with Up-Arrow key, replace "getLoudness" with "Input.GetAxis("Vertical")"
  ...
  void FixedUpdate()
  {
	...
	public void MoveForeward (){
		m_body.velocity = new Vector2 (m_forwardAcl, 0);
	}
